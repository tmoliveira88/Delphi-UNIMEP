object frmRelEstoque: TfrmRelEstoque
  ...
  object qryRelEstoque: TADOQuery
    Active = True
    ...
    Left = 8
    Top = 14
    object qryRelEstoquepro_id: TLargeintField
      FieldName = 'pro_id'
    end
    object qryRelEstoquepro_nome: TStringField
      FieldName = 'pro_nome'
      Size = 80
    end
    object qryRelEstoquepro_foto: TBlobField
      FieldName = 'pro_foto'
    end
    object qryRelEstoquepro_preco: TBCDField
      FieldName = 'pro_preco'
      DisplayFormat = ',R$ #0.00'
      Precision = 18
      Size = 2
    end
    object qryRelEstoquepro_custo: TBCDField
      FieldName = 'pro_custo'
      DisplayFormat = ',R$ #0.00'
      Precision = 18
      Size = 2
    end
    object qryRelEstoquepro_atividade: TStringField
      FieldName = 'pro_atividade'
      Size = 1
    end
    object qryRelEstoquepro_quantidade: TIntegerField
      FieldName = 'pro_quantidade'
      DisplayFormat = ',#,00'
    end
    object qryRelEstoquepro_qtd_alerta: TIntegerField
      FieldName = 'pro_qtd_alerta'
      DisplayFormat = ',#,00'
    end
    object qryRelEstoquepro_data_cadastro: TWideStringField
      FieldName = 'pro_data_cadastro'
      Size = 19
    end
    object qryRelEstoquepro_data_inativo: TWideStringField
      FieldName = 'pro_data_inativo'
      Size = 19
    end
    object qryRelEstoquepro_peso: TFloatField
      FieldName = 'pro_peso'
      DisplayFormat = ',#,00'
    end
    object qryRelEstoquepro_id_for: TIntegerField
      FieldName = 'pro_id_for'
    end
    object qryRelEstoquefor_razaosocial_nome: TStringField
      FieldName = 'for_razaosocial_nome'
      Size = 80
    end
    object qryRelEstoquefor_nome_fantasia: TStringField
      FieldName = 'for_nome_fantasia'
      Size = 50
    end
    object qryRelEstoquefor_email: TStringField
      FieldName = 'for_email'
      Size = 80
    end
    object qryRelEstoquefor_telefone: TStringField
  ...
  object qryRelEstoquexConfig: TADOQuery
    Active = True
    Connection = DM.adoConexao
    CursorType = ctStatic
    Parameters = <>
    ...
    Left = 304
    Top = 16
    object qryRelEstoquexConfigconf_id: TAutoIncField
      FieldName = 'conf_id'
      ReadOnly = True
    end
    object qryRelEstoquexConfigconf_razao_social: TStringField
      FieldName = 'conf_razao_social'
      Size = 100
    end
    object qryRelEstoquexConfigconf_nome_fantasia: TStringField
      FieldName = 'conf_nome_fantasia'
      Size = 50
    end
    object qryRelEstoquexConfigconf_cnpj: TStringField
      FieldName = 'conf_cnpj'
      Size = 18
    end
    object qryRelEstoquexConfigconf_ie: TStringField
      FieldName = 'conf_ie'
    end
    object qryRelEstoquexConfigconf_tel: TStringField
      FieldName = 'conf_tel'
      Size = 13
    end
    object qryRelEstoquexConfigconf_cel: TStringField
      FieldName = 'conf_cel'
      Size = 14
    end
    object qryRelEstoquexConfigconf_email: TStringField
      FieldName = 'conf_email'
      Size = 80
    end
    object qryRelEstoquexConfigconf_site: TStringField
      FieldName = 'conf_site'
      Size = 50
    end
    object qryRelEstoquexConfigconf_endereco: TStringField
      FieldName = 'conf_endereco'
      Size = 50
    end
    object qryRelEstoquexConfigconf_num_end: TStringField
      FieldName = 'conf_num_end'
      Size = 6
    end
    object qryRelEstoquexConfigconf_bairro: TStringField
      FieldName = 'conf_bairro'
      Size = 50
    end
    object qryRelEstoquexConfigconf_CEP: TStringField
      FieldName = 'conf_CEP'
      Size = 10
    end
    object qryRelEstoquexConfigconf_cid_id: TIntegerField
      FieldName = 'conf_cid_id'
    end
    object qryRelEstoquexConfigconf_estado: TStringField
      FieldName = 'conf_estado'
      Size = 100
    end
    object qryRelEstoquexConfigcid_nome: TStringField
      FieldName = 'cid_nome'
      Size = 100
    end
  end
  ...
  object frxDBDataset2: TfrxDBDataset
    ...
    CloseDataSource = False
    DataSet = qryRelEstoquexConfig
    BCDToCurrency = False
    Left = 352
    Top = 16
  end
  object frxRelEstoque: TfrxReport
    Version = '6.0.10'
    ...
    ReportOptions.LastChange = 43435.809925694450000000
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBDataset1."for_nome_fantasia"'
        object Memo11: TfrxMemoView
          Top = 4.779530000000000000
          Width = 718.110260630000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
