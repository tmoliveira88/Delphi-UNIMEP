...
type
  TfrmPagamentoDebito = class(TForm)
    Panel1: TPanel;
    GroupBox1: TGroupBox;
    edtvalor: TEdit;
    Button1: TButton;
...
var
  frmPagamentoDebito: TfrmPagamentoDebito;
...
procedure TfrmPagamentoDebito.BitBtn1Click(Sender: TObject);
...
procedure TfrmPagamentoDebito.btnCancelarClick(Sender: TObject);
begin
close;
end;

procedure TfrmPagamentoDebito.Button1Click(Sender: TObject);
begin
edtvalor.Text := FormatFloat('#0.00',(frmPagamentoVCaixa.total - DM.qryTotalPagamentos.fieldbyname('str').AsFloat));
end;

procedure TfrmPagamentoDebito.Button2Click(Sender: TObject);
begin
edtvalor.Text := '0,00';
end;

procedure TfrmPagamentoDebito.Button3Click(Sender: TObject);
begin
edtvalor.Text := '5,00';
end;

procedure TfrmPagamentoDebito.Button4Click(Sender: TObject);
begin
edtvalor.Text := '10,00';
end;

procedure TfrmPagamentoDebito.Button5Click(Sender: TObject);
begin
edtvalor.Text := '20,00';
end;

procedure TfrmPagamentoDebito.Button6Click(Sender: TObject);
begin
edtvalor.Text := '50,00';
end;

procedure TfrmPagamentoDebito.Button7Click(Sender: TObject);
begin
edtvalor.Text := '2,00';
end;

procedure TfrmPagamentoDebito.CheckBox1Click(Sender: TObject);
begin
if Checkbox1.checked = true then
begin
...
procedure TfrmPagamentoDebito.CheckBox2Click(Sender: TObject);
begin
...
procedure TfrmPagamentoDebito.CheckBox3Click(Sender: TObject);
begin
...
procedure TfrmPagamentoDebito.CheckBox4Click(Sender: TObject);
begin
...
procedure TfrmPagamentoDebito.Edit1KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfrmPagamentoDebito.Edit2KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfrmPagamentoDebito.edtvalorKeyPress(Sender: TObject; var Key: Char);
begin
     if not (CharInSet(key,['0'..'9', char(vk_back)])) then
     begin
          key := #0;
...
procedure TfrmPagamentoDebito.FormClose(Sender: TObject;
...
procedure TfrmPagamentoDebito.FormShow(Sender: TObject);
begin
...
procedure TfrmPagamentoDebito.Image1Click(Sender: TObject);
begin
...
procedure TfrmPagamentoDebito.Image2Click(Sender: TObject);
begin
...
procedure TfrmPagamentoDebito.Image3Click(Sender: TObject);
begin
...
procedure TfrmPagamentoDebito.Image4Click(Sender: TObject);
begin
