object frmRelProdutos: TfrmRelProdutos
  ...
  object Panel2: TPanel
    ...
    object cbxFornecedor: TDBLookupComboBox
      ...
      Font.Style = []
      KeyField = 'for_id'
      ListField = 'for_nome_fantasia'
      ListSource = dsFornecedor
      ParentFont = False
      TabOrder = 7
    end
  end
  object qryRelProdutos: TADOQuery
    Active = True
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM pro_produto'
      'INNER JOIN for_fornecedor'
      'ON pro_id_for = for_id')
    Left = 8
    Top = 14
    object qryRelProdutospro_id: TLargeintField
      FieldName = 'pro_id'
    end
    object qryRelProdutospro_nome: TStringField
      FieldName = 'pro_nome'
      Size = 80
    end
    object qryRelProdutospro_foto: TBlobField
      FieldName = 'pro_foto'
    end
    object qryRelProdutospro_preco: TBCDField
      FieldName = 'pro_preco'
      DisplayFormat = ',R$ #0.00'
      Precision = 18
      Size = 2
    end
    object qryRelProdutospro_custo: TBCDField
      FieldName = 'pro_custo'
      DisplayFormat = ',R$ #0.00'
      Precision = 18
      Size = 2
    end
    object qryRelProdutospro_atividade: TStringField
      FieldName = 'pro_atividade'
      Size = 1
    end
    object qryRelProdutospro_quantidade: TIntegerField
      FieldName = 'pro_quantidade'
      DisplayFormat = ',#,00'
    end
    object qryRelProdutospro_qtd_alerta: TIntegerField
      FieldName = 'pro_qtd_alerta'
      DisplayFormat = ',#,00'
    end
    object qryRelProdutospro_data_cadastro: TWideStringField
      FieldName = 'pro_data_cadastro'
      Size = 19
    end
    object qryRelProdutospro_data_inativo: TWideStringField
      FieldName = 'pro_data_inativo'
      Size = 19
    end
    object qryRelProdutospro_peso: TFloatField
      FieldName = 'pro_peso'
      DisplayFormat = ',#,00'
    end
    object qryRelProdutospro_id_for: TIntegerField
      FieldName = 'pro_id_for'
    end
    object qryRelProdutosfor_razaosocial_nome: TStringField
      FieldName = 'for_razaosocial_nome'
      Size = 80
    end
    object qryRelProdutosfor_nome_fantasia: TStringField
  ...
  object frxRelProdutosAnalitico: TfrxReport
    Version = '6.0.10'
    ...
    ReportOptions.LastChange = 43434.612968159720000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBDataset1cli_nome: TfrxMemoView
          IndexTag = 1
          Left = 223.795300000000000000
          Top = 23.622062500000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDataset1."pro_nome"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object frxDBDataset1cli_id: TfrxMemoView
          IndexTag = 1
          Left = 208.204700000000000000
        ...
        object frxDBDataset1pro_preco: TfrxMemoView
          IndexTag = 1
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDataset1."pro_preco"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object frxDBDataset1for_nome_fantasia: TfrxMemoView
          IndexTag = 1
          Left = 232.787570000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDataset1."for_nome_fantasia"]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object frxDBDataset1pro_quantidade: TfrxMemoView
          IndexTag = 1
          Left = 253.228510000000000000
          Top = 70.866187500000000000
          Width = 79.370130000000000000
          Height = 18.897650000000000000
        ...
        object frxDBDataset1pro_qtd_alerta: TfrxMemoView
          IndexTag = 1
          Left = 563.149970000000000000
          Top = 71.055118110236200000
          Width = 79.370130000000000000
          Height = 18.897650000000000000
          DataField = 'pro_qtd_alerta'
          DataSet = frxDBDataset1
          DataSetName = 'frxDBDataset1'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object frxDBDataset1pro_custo: TfrxMemoView
          IndexTag = 1
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDataset1."pro_custo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object frxDBDataset1pro_peso: TfrxMemoView
          IndexTag = 1
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Relat'#243'rio de Produtos - Anal'#237'tico')
          ParentFont = False
        end
        object frxDBDataset2conf_nome_fantasia: TfrxMemoView
          IndexTag = 1
          Left = 179.519790000000000000
  ...
  object qryRelProdutosxConfig: TADOQuery
    Active = True
    Connection = DM.adoConexao
    CursorType = ctStatic
    Parameters = <>
    ...
    Left = 304
    Top = 16
    object qryRelProdutosxConfigconf_id: TAutoIncField
      FieldName = 'conf_id'
      ReadOnly = True
    end
    object qryRelProdutosxConfigconf_razao_social: TStringField
      FieldName = 'conf_razao_social'
      Size = 100
    end
    object qryRelProdutosxConfigconf_nome_fantasia: TStringField
      FieldName = 'conf_nome_fantasia'
      Size = 50
    end
    object qryRelProdutosxConfigconf_cnpj: TStringField
      FieldName = 'conf_cnpj'
      Size = 18
    end
    object qryRelProdutosxConfigconf_ie: TStringField
      FieldName = 'conf_ie'
    end
    object qryRelProdutosxConfigconf_tel: TStringField
      FieldName = 'conf_tel'
      Size = 13
    end
    object qryRelProdutosxConfigconf_cel: TStringField
      FieldName = 'conf_cel'
      Size = 14
    end
    object qryRelProdutosxConfigconf_email: TStringField
      FieldName = 'conf_email'
      Size = 80
    end
    object qryRelProdutosxConfigconf_site: TStringField
      FieldName = 'conf_site'
      Size = 50
    end
    object qryRelProdutosxConfigconf_endereco: TStringField
      FieldName = 'conf_endereco'
      Size = 50
    end
    object qryRelProdutosxConfigconf_num_end: TStringField
      FieldName = 'conf_num_end'
      Size = 6
    end
    object qryRelProdutosxConfigconf_bairro: TStringField
      FieldName = 'conf_bairro'
      Size = 50
    end
    object qryRelProdutosxConfigconf_CEP: TStringField
      FieldName = 'conf_CEP'
      Size = 10
    end
    object qryRelProdutosxConfigconf_cid_id: TIntegerField
      FieldName = 'conf_cid_id'
    end
    object qryRelProdutosxConfigconf_estado: TStringField
      FieldName = 'conf_estado'
      Size = 100
    end
    object qryRelProdutosxConfigcid_nome: TStringField
      FieldName = 'cid_nome'
      Size = 100
    end
  end
  ...
  object frxRelProdEtiquetas: TfrxReport
    Version = '6.0.10'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick, pbCopy, pbSelection]
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 43429.680632372700000000
    ReportOptions.LastChange = 43435.502462025500000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'frxDBDataset1'
        RowCount = 0
        object frxDBDataset1pro_nome: TfrxMemoView
          IndexTag = 1
        ...
        object BarCode1: TfrxBarCodeView
          ...
          BarType = bcCode39
          Expression = '<frxDBDataset1."pro_id">'
          Frame.Typ = []
          Rotation = 0
          TestLine = False
          Text = '12345678'
  ...
  object frxRelProdutosSintetico: TfrxReport
    Version = '6.0.10'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick, pbCopy, pbSelection]
    ...
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 43427.546714108800000000
    ReportOptions.LastChange = 43434.615407592600000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
    ...
    object Page1: TfrxReportPage
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo10: TfrxMemoView
          Left = 436.425187090000000000
          Top = 56.688188000000000000
        ...
        object SysMemo2: TfrxSysMemoView
          ...
          Memo.UTF8W = (
              ...
              '[SUM(<frxDBDataset1."pro_quantidade">*<frxDBDataset1."pro_custo"' +
              '>+<frxDBDataset1."pro_peso">*<frxDBDataset1."pro_custo">,MasterD' +
              'ata1)]')
          ParentFont = False
        end
        object SysMemo3: TfrxSysMemoView
          ...
          Memo.UTF8W = (
              ...
              '[SUM(<frxDBDataset1."pro_quantidade">+<frxDBDataset1."pro_peso">' +
              ',MasterData1)]')
          ParentFont = False
        end
        object Memo12: TfrxMemoView
          Left = 434.645950000000000000
          Top = 78.741744000000000000
